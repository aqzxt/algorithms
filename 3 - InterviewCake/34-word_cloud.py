"""
Created on Mon Feb 26 23:39:08 2018 ----------- @author: mxhfield
"""
...
def word_cloud(text):
    ...
    for k in text:
        ...
        elif not dict.get(word) and word:
            dict[word] = 1
            word = ''
        elif word:
            dict[word] += 1
...
t1 = "After beating the eggs, Dana read the next you're step: \
        Add milk and eggs, then add flour and sugar."
t2 = "We came, we saw, we conquered...then we ate Bill's (Mille-Feuille) cake."
t3 = "The bill came to five dollars."
